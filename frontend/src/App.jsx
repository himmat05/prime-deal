        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center cursor-pointer" onClick={() => setCurrentPage('home')}>
              <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-lg flex items-center justify-center mr-3 shadow-lg transform hover:scale-110 transition-transform duration-200">
            ...
            <div className="flex items-center gap-2">
              {user ? (
                <>
                  ...
                  <div className="hidden sm:flex items-center px-3 py-2 ml-2 bg-gray-100 rounded-lg">
                  ...
                  <button
                    ...
                    className="ml-2 px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg font-medium hover:from-red-600 hover:to-red-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
                  >
                    Logout
                  </button>
                </>
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-medium hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
                >
                  Login
                </button>
              )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Your trusted online shopping destination. Discover quality products at amazing prices with fast, reliable delivery.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="hover:text-blue-400 transition-colors duration-200">Shipping Info</a></li>
                <li><a href="#" className="hover:text-blue-400 transition-colors duration-200">Returns</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="hover:text-blue-400 transition-colors duration-200">Track Order</a></li>
              </ul>
            </div>
          </div>
